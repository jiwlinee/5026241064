            ...
            <div class="container">
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 order-1 order-lg-2 hero-img text-end" data-aos="zoom-out" data-aos-delay="200">
                        <img src="assets/img/logo-dell.png" class="img-fluid animated" style="width: 70%;">
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-7 d-flex flex-column justify-content-center order-2 order-lg-1">
                        <div class="content px-xl-5 text-start" data-aos="fade-up" data-aos-delay="100">
                            <h1 class="fs-2"><span>“The XPS 14 is back and better than ever.” - </span><strong>@zdnet_official</strong></h1>
                            <p class="large">
                    ...
                    <div class="col-lg-5 order-1 order-lg-2 why-us-img">
                        <img src="assets/img/dell-xps-14.png" class="img-fluid" alt="" data-aos="zoom-in"
                            data-aos-delay="100">
                    </div>
                </div>
